...
def glueURL(ticks, lY_unix,lM_unix, curr_unix, data_time):
     ...
     for t in ticks:
          ...
          url_candles.append(stockCandleUrl)
          url_prices.append(currStockPriceURL)
     return url_candles, url_prices
